    ...
    for (let i = 1; i <= 5; i++) {
        ...
        const member = await prisma.member.create({
            data: {
                ...
                simpananPokok: new library_1.Decimal(50000),
                simpananWajib: new library_1.Decimal(200000 + i * 50000),
                simpananSukarela: new library_1.Decimal(150000 + i * 100000),
                status: 'ACTIVE',
            },
        });
        users.push(user);
    ...
    const products = await Promise.all([
        prisma.product.create({
            data: {
                ...
                sku: 'BRS001',
                buyPrice: new library_1.Decimal(45000),
                sellPrice: new library_1.Decimal(50000),
                stock: 25,
                threshold: 10,
                unit: 'sak',
            },
        ...
        prisma.product.create({
            data: {
                ...
                categoryId: categories[0].id,
                sku: 'MNG001',
                buyPrice: new library_1.Decimal(25000),
                sellPrice: new library_1.Decimal(28000),
                stock: 8, // Low stock
                threshold: 15,
                unit: 'botol',
            },
        ...
        prisma.product.create({
            data: {
                ...
                categoryId: categories[0].id,
                sku: 'GUL001',
                buyPrice: new library_1.Decimal(12000),
                sellPrice: new library_1.Decimal(14000),
        ...
        prisma.product.create({
            data: {
                ...
                sku: 'KOP001',
                buyPrice: new library_1.Decimal(15000),
                sellPrice: new library_1.Decimal(18000),
                stock: 30,
                threshold: 10,
                unit: 'pack',
            },
        ...
        prisma.product.create({
            data: {
                ...
                categoryId: categories[1].id,
                sku: 'TEH001',
                buyPrice: new library_1.Decimal(8000),
                sellPrice: new library_1.Decimal(10000),
                stock: 20,
                threshold: 5,
                unit: 'kotak',
            },
    ...
    for (let i = 0; i < 3; i++) {
        ...
        const transaction = await prisma.transaction.create({
            data: {
                ...
                type: 'SALE',
                totalAmount: new library_1.Decimal(totalPrice),
                paymentMethod: 'CASH',
                status: 'COMPLETED',
