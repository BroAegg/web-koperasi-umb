  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-white to-blue-50">
      <div className="min-h-screen grid lg:grid-cols-2">
        ...
        <div className="hidden lg:flex flex-col items-center justify-center bg-gradient-to-br from-emerald-600 to-emerald-700 text-white relative overflow-hidden">
          ...
          <div className="relative z-10 text-center space-y-6 px-8">
            ...
            <div className="space-y-4">
              <h1 className="text-4xl font-bold">Bergabung dengan Kami</h1>
              <p className="text-emerald-100 text-lg max-w-md">
                Daftar sekarang dan nikmati kemudahan mengelola koperasi digital
              </p>
            </div>
            ...
            <div className="space-y-3 text-left max-w-sm">
              <div className="flex items-center space-x-3">
                ...
                <span className="text-emerald-100 text-sm">Manajemen anggota yang mudah</span>
              </div>
              <div className="flex items-center space-x-3">
                <CheckCircle className="w-5 h-5 text-emerald-200" />
                <span className="text-emerald-100 text-sm">Sistem inventori terintegrasi</span>
              </div>
              <div className="flex items-center space-x-3">
                <CheckCircle className="w-5 h-5 text-emerald-200" />
                <span className="text-emerald-100 text-sm">Laporan keuangan real-time</span>
              </div>
              <div className="flex items-center space-x-3">
                <CheckCircle className="w-5 h-5 text-emerald-200" />
                <span className="text-emerald-100 text-sm">Notifikasi otomatis</span>
              </div>
            </div>
              ...
              <CardContent className="p-6 sm:p-8">
                <div className="text-center mb-6">
                  ...
                  <p className="text-gray-600 text-sm sm:text-base">
                    Bergabunglah dengan komunitas koperasi digital kami
                  </p>
                </div>
                  ...
                  <div className="space-y-3">
                    <label className="flex items-start space-x-3 cursor-pointer text-sm">
                      <input
                        ...
                        onChange={(e: React.ChangeEvent<HTMLInputElement>) => setFormData({...formData, agreeTerms: e.target.checked})}
