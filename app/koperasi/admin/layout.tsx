...
export default function AdminLayout({
  ...
  const { user, loading, authorized, logout } = useAuth(["ADMIN"]);
  ...
  const navigation = [
    { name: "Dashboard", href: "/koperasi/admin", icon: LayoutDashboard },
    { name: "Inventory", href: "/koperasi/admin/inventory", icon: Package },
    { name: "Membership", href: "/koperasi/admin/membership", icon: Users },
    { name: "Keuangan", href: "/koperasi/admin/financial", icon: TrendingUp },
    { name: "Broadcast", href: "/koperasi/broadcast", icon: Megaphone },
    { name: "Pengaturan", href: "/koperasi/settings", icon: Settings },
  ];

  const isActive = (href: string) => {
    if (href === "/koperasi/admin") {
