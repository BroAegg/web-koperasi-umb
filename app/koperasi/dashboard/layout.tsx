...
export default function UserDashboardLayout({
  ...
  const { user, loading, authorized, logout } = useAuth(["USER"]);
  ...
  const navigation = [
    { name: "Dashboard", href: "/koperasi/dashboard", icon: LayoutDashboard },
    { name: "Produk", href: "/koperasi/inventory", icon: Package },
    { name: "Transaksi", href: "/koperasi/financial", icon: Receipt },
      ...
      <div className="lg:pl-64">
        ...
        <header className="lg:hidden sticky top-0 z-30 bg-white shadow-md">
          <div className="flex items-center justify-between p-4">
            ...
            <h1 className="text-lg font-bold text-slate-800">Member Portal</h1>
