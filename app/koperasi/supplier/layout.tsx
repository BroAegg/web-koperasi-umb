...
export default function SupplierLayout({
  ...
  const navigation = [
    ...
    { name: "Produk Saya", href: "/koperasi/supplier/products", icon: Package },
    { name: "Pesanan", href: "/koperasi/supplier/orders", icon: ShoppingCart },
    { name: "Transaksi", href: "/koperasi/supplier/transactions", icon: Receipt },
    { name: "Broadcast", href: "/koperasi/supplier/broadcast", icon: Megaphone },
    { name: "Profil", href: "/koperasi/supplier/profile", icon: User },
  ];

  const isActive = (href: string) => {
    if (href === "/koperasi/supplier") {
